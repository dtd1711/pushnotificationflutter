...
class Coffee {
  ...
  factory Coffee.fromMap(Map<String,dynamic> map) {
    return Coffee(
      ...
      locationCoords: LatLng(map['locationCoords']['lat'], map['locationCoords']['lat'])
    );
  }
}
...
final List<Coffee> coffeeShops = [
  Coffee(
      ...
      locationCoords: LatLng(10.7837, 106.6386),
  ...
  Coffee(
      ...
      locationCoords: LatLng(10.7757, 106.7004),
  ...
  Coffee(
      ...
      locationCoords: LatLng(10.7866, 106.6382),
  ...
  Coffee(
      ...
      locationCoords: LatLng(10.7841, 106.639),
